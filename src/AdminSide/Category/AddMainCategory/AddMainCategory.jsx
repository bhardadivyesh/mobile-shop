...
const AddMainCategory = () => {
  ...
  <div className="mb-4">
    <label htmlFor="name" className="text-sm font-medium text-white">Enter Category Name :</label>
    <input
      id="name"
      type="text"
    ...
    />
    {errors.categoryname && <p className="text-red-500 text-sm">Enter Category Name :</p>}
    <label
                htmlFor="photo"
  ...
  <div>
    ...
    <button type="submit" className="bg-blue-900 text-white font-semibold px-4 py-2 rounded ml-32">Submit</button>
  </div>
</form>
      </div>
      <Footer />
